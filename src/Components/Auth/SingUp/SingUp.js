...
const Login = () => {
  ...
  const [updateProfile] = useUpdateProfile(auth, { sendEmailVerification: true });
        ...
        <div className="singUp-form">
          <form onSubmit={handleCreateAccount} className=''>
            ...
            <div className="input-div pb-3">
              ...
              <label className={`pl-2 ${agree ? 'text-blue-400 ' : "text-black pl-2"}`} >Read and Agree
                <Link to='/login' className={agree ? 'text-blue-400 pl-2' : "text-red-500 pl-2 underline"}>Terms and contrition</Link></label>
            </div>
            ...
            <button
              disabled={!agree}
              className='w-full bg-blue-400 hover:bg-blue-600 border-blue-400 text-center border-solid rounded border  text-xl font-medium p-2  text-white '>Registrar</button>
          </form>
